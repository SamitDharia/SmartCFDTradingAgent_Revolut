...
"venv\Scripts\python.exe" -m SmartCFDTradingAgent.pipeline --config configs/equities.yml --profile equities_daily --broker alpaca --use-params --ml-blend auto --ml-threshold 0.65 --budget-mode auto --retrain-interval-hours 4 %*
popd
